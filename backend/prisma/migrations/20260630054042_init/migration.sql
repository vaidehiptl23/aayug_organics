...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('UPI', 'CARD', 'COD', 'RAZORPAY', 'PAYU', 'CASHFREE');

-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('RAZORPAY', 'PAYU', 'CASHFREE', 'COD', 'INTERNAL');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_PLACED', 'ORDER_CONFIRMED', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_CANCELLED', 'PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'REFUND_INITIATED', 'REFUND_COMPLETED', 'EMAIL_VERIFICATION', 'PASSWORD_RESET', 'REGISTRATION', 'LOW_STOCK');
...
CREATE TABLE "products" (
    ...
    "description" TEXT,
    "sku" TEXT NOT NULL,
    "brand" TEXT NOT NULL DEFAULT 'Aayug Organics',
