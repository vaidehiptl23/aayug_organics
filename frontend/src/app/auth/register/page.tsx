    ...
    <div className="flex min-h-screen items-center justify-center bg-[#fcfbf7] px-4 dark:bg-gray-950">
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500 font-medium">Join Aayug Organics in one click using Google.</p>
        </div>
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-xl dark:border-gray-800 dark:bg-gray-900 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
            Registration is powered exclusively by Google to ensure the highest standard of account security and speed.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800">
            <p className="text-xs text-gray-400 dark:text-gray-500 leading-relaxed">
              By signing up, you agree to Aayug Organics&apos; <Link href="/" className="underline hover:text-gray-600">Terms of Service</Link> and <Link href="/" className="underline hover:text-gray-600">Privacy Policy</Link>.
            </p>
          </div>
        </div>
      </div>
