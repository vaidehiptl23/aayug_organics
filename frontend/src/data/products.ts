...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      { id: "g1", url: "/products/ghee/ghee-front.jpg",      alt: "A2 Gir Cow Ghee - Front View" },
      { id: "g2", url: "/products/ghee/ghee-back.jpg",       alt: "A2 Gir Cow Ghee - Back Label" },
      { id: "g3", url: "/products/ghee/ghee-banner.jpg",     alt: "A2 Gir Cow Ghee - Benefits" },
      { id: "g4", url: "/products/ghee/ghee-bilona.jpg",     alt: "Bilona Method" },
      { id: "g5", url: "/products/ghee/ghee-why.jpg",        alt: "Why Aayug Ghee is Better" },
      { id: "g6", url: "/products/ghee/ghee-choose.jpg",     alt: "Why Choose Aayug" },
      { id: "g7", url: "/products/ghee/ghee-nutrition.jpg",  alt: "Nutrition Facts" },
      { id: "g8", url: "/products/ghee/ghee-process.jpg",    alt: "Traditional Process" },
      { id: "g9", url: "/products/ghee/ghee-benefits.jpg",   alt: "Health Benefits" },
    ],
